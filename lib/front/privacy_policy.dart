    ...
    child: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          buildParagraph(
            'We stress the importance of privacy and are committed to earning your trust by adopting high standards for the protection of your personal information. '
            'This policy applies to our website(s) and outlines the type of personal information we collect and receive...',
          ),

          const SizedBox(height: 24),
          buildSectionTitle('HOW YOU MAY PROVIDE US YOUR PERSONAL INFORMATION USING OUR WEBSITE'),

          buildParagraph(
            '1. By making a reservation or by using the website.\n'
            '2. By communicating with us regarding service delivery including any profiles, preferences or special requests.\n'
            '3. By participating in a marketing initiative, survey or responding to special offers.\n'
            '4. By registering or entering information on our website.',
          ),

          const SizedBox(height: 24),
          buildSectionTitle('MAKING A RESERVATION / COMPLETING FORMS'),

          buildParagraph(
            'When making a reservation or using forms on the website, it is necessary to provide information to identify you and process your request...',
          ),

          const SizedBox(height: 24),
          buildSectionTitle('WE OFFER YOU THE ABILITY TO RECEIVE TARGETED NOTIFICATIONS'),

          buildParagraph(
            'To sign up for this service we require your email address, first name, last name, and zip code. You may unsubscribe at any time.',
          ),

          const SizedBox(height: 24),
          buildSectionTitle('BY VISITING OUR WEBSITE'),

          buildParagraph(
            'Our website does not collect personally identifiable information unless you provide it. We log only technical information needed for site functionality.',
          ),

          const SizedBox(height: 24),
          buildSectionTitle('WHY WE COLLECT PERSONAL INFORMATION'),

          buildParagraph(
            '1. To maintain and honor our relationship with you.\n'
            '2. To better understand your preferences.\n'
            '3. To improve our services.\n'
            '4. To meet legal requirements.',
          ),

          const SizedBox(height: 24),
          buildSectionTitle('WHEN DO WE DISCLOSE PERSONAL INFORMATION'),

          buildParagraph(
            '1. Internally with authorized departments.\n'
            '2. With persons acting on your behalf (travel agents, etc.).\n'
            '3. With third parties to process transactions.\n'
            '4. With law enforcement where required.',
          ),

          const SizedBox(height: 24),
          buildSectionTitle('PRINCIPLES'),

          buildParagraph(
            '1. We will only use your information for stated purposes.\n'
            '2. We safeguard your information.\n'
            '3. We work with third parties who comply with confidentiality standards.\n'
            '4. You may update or correct your information at any time.',
          ),
